          ...
          <div className="h-16 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              <Link
                ...
                className="px-4 h-9 inline-flex items-center rounded-lg border border-borderStrong text-sm font-medium text-textPrimary hover:bg-mainBg transition-colors"
              >
                Вход за клиент
              </Link>
              <Link
                to="/auth/service-role"
                className="px-4 h-9 inline-flex items-center rounded-lg border border-borderStrong text-sm font-medium text-textPrimary hover:bg-mainBg transition-colors"
              >
                Вход за сервиз
              </Link>
              <Link
                to="/register"
                className="px-4 h-9 inline-flex items-center rounded-lg bg-primary text-white text-sm font-semibold hover:bg-primary-700 transition-colors"
              >
                Регистрация
              </Link>
            </div>
            ...
            <div className="px-4 py-4 space-y-2">
              ...
              <div className="pt-3 border-t border-borderSubtle grid gap-2">
                <Link
                  to="/login?role=client"
                  onClick={() => setMobileOpen(false)}
                  className="px-4 h-10 inline-flex items-center justify-center rounded-lg border border-borderStrong text-sm font-medium text-textPrimary hover:bg-mainBg transition-colors"
                >
                  Вход за клиент
                </Link>
                <Link
                ...
                <Link
                  to="/register"
                  onClick={() => setMobileOpen(false)}
                  className="px-4 h-10 inline-flex items-center justify-center rounded-lg bg-primary text-white text-sm font-semibold hover:bg-primary-700 transition-colors"
                >
                  Регистрация
                </Link>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3">
                  <Link
                    to="/register"
                    className="px-6 h-12 inline-flex items-center justify-center rounded-lg bg-primary text-white font-semibold hover:bg-primary-700 transition-colors"
                  >
                  ...
                  <Link
                    to="/auth/service-role"
                    className="px-6 h-12 inline-flex items-center justify-center rounded-lg border border-borderStrong text-textPrimary font-semibold hover:bg-mainBg transition-colors"
                  >
                    Вход за сервиз
                  </Link>
                  <Link
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
              ...
              >
                ...
                <p className="text-sm font-semibold">Вход за клиент</p>
              </Link>
              ...
              >
                ...
                <p className="text-sm font-semibold">Вход за сервиз</p>
              </Link>
              ...
              >
                ...
                <p className="text-sm font-semibold">Регистрация</p>
              </Link>
            </div>
          </div>
        </section>
