      ...
      <div className="max-w-2xl mx-auto p-4 sm:p-8 text-center">
        <div className="mb-8">
          ...
          <p className="text-textSecondary">
            Нямаш активни сервизи в момента
          </p>
        </div>
        ...
        <div className="text-sm text-textSecondary">
          <p>За да започнеш работа, трябва да се присъединиш към сервиз.</p>
          <p className="mt-2">Ако имаш въпроси, свържи се с администратора на твоя сервиз.</p>
        </div>
      </div>
    </MainLayout>
  );
