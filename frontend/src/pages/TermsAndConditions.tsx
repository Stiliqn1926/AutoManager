    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 py-12 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="prose max-w-none">
          ...
          <p className="text-gray-700 mb-4">
            <strong>2.2.</strong> Потребителите са длъжни да предоставят верни и актуални данни при регистрация.
          </p>
          <p className="text-gray-700 mb-4">
            <strong>2.3.</strong> Всеки потребител носи отговорност за запазване в тайна на своята парола и за всички действия, извършени чрез неговия акаунт.
          </p>
          <p className="text-gray-700 mb-4">
            <strong>2.4.</strong> Механиците се регистрират чрез уникален код на автосервиза и изискват одобрение от администратор преди да получат достъп до системата.
          </p>
          ...
          <ul className="list-disc pl-8 mb-4 text-gray-700">
            <li>Имат пълен достъп до управлението на автосервиза</li>
            <li>Отговарят за одобряването на механици</li>
            <li>Управляват клиенти, поръчки, финанси и настройки</li>
            <li>Носят отговорност за коректността на издаваните фактури</li>
          </ul>
          ...
          <ul className="list-disc pl-8 mb-4 text-gray-700">
            <li>Създават и редактират поръчки</li>
            <li>Имат достъп до информация за клиенти и автомобили (само за четене)</li>
            <li>Следят своя работен график</li>
            <li>Нямат достъп до финансова информация</li>
          </ul>
          ...
          <ul className="list-disc pl-8 mb-4 text-gray-700">
            <li>Проследяват статуса на своите ремонти</li>
            <li>Имат достъп до сервизната история на автомобилите си</li>
            <li>Получават и преглеждат фактури</li>
            <li>Получават известия при промяна на статус на поръчка</li>
          </ul>
          ...
          <p className="text-gray-700 mb-4">
            <strong>4.2.</strong> Събираните данни включват: имейл адрес, име, телефон, данни за фирми и автомобили, история на поръчки.
          </p>
          <p className="text-gray-700 mb-4">
